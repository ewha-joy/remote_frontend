                    ...
                    this.state.user ? (
                        <div class="wrap">        
                            ...
                            <div class="shippingStatusContainer">
                                <div class="title">보유 자산</div>
                                <div class="status">
                                    <div class="item">
                                        <div>
                                            <div class="green number">{this.state.user.cash}  원</div>
                            ...
                            <div class="listContainer">
                                <a href="#" class="item">
                                    <div class="icon">:</div>
                                    <div class="text"><FaCoins className="icon" size="20" color="red"/>10,000 원</div>
                                    <div class="text"></div>
                                ...
                                <a href="#" class="item">
                                    <div class="icon">:</div>
                                    <div class="text"><FaCoins className="icon" size="20" color="red"/>100,000 원</div>
                                    <div class="text"></div>
